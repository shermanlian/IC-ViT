...
from icvit import transformations
from icvit.data.s3dataset import S3Dataset
...
class So2Sat(S3Dataset):
    ...
    def __init__(
        ...
        normalization_mean=np.array(transform_cfg.normalization.mean)#/4095.
        normalization_std=np.array(transform_cfg.normalization.std)#/4095.
    ...
    def __getitem__(self, index):
        ...
        return (
            ...
            {"channels": channels, "label": label, "n_channels": len(channels)},
        )
